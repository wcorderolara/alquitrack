...
exports.getTiposCredito = function(req, res){
	models.tipoCredito.findAll({
		where: {
			status: 1
		}
...
exports.getTipoCredito = function(req, res){
	models.tipoCredito.findOne({
		where: {
			id: req.params.id,
			status: 1
		}
...
exports.postTipoCredito = function(req, res){
	models.tipoCredito.create({
...
exports.putTipoCredito = function(req, res){
	models.tipoCredito.update({
		descripcion: req.body.descripcion
	},{
		where: {
			id: req.params.id
...
exports.deleteTipoCredito = function(req, res){
	models.tipoCredito.update({
		status: 0
	},{
		where: {
